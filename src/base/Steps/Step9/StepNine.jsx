    ...
    <div className="stepNineWrapper">
      ...
      <div className="stepNineInstructionswrapper">
        <div className="stepNineone">
          ...
          justice at stake, only your quick wit and steady aim can bring an end
          to the tyranny once and for all.
        </div>
        <div className="stepNinetwo">
          Hint: dir, ls, ls -a, cat find, sudo, rm{" "}
        </div>
      </div>
    </div>
  );
